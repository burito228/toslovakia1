...
(() => {
            ...
            var l = (function (a2, b2, c2) {
               ...
               m = {
                  ...
                  "ease-in-sine": [
                     ...
                     function (a2, b2, c2, d2) {
                        return (
                           -c2 * Math.cos((a2 / d2) * (Math.PI / 2)) + c2 + b2
                        );
                     },
                  ],
                  "ease-out-sine": [
                  ...
                  "ease-in-out-sine": [
                     ...
                     function (a2, b2, c2, d2) {
                        return (
                           (-c2 / 2) * (Math.cos((Math.PI * a2) / d2) - 1) + b2
                        );
                     },
                  ],
                  "ease-in-expo": [
            ...
            var J = (b.frame = (function () {
               ...
               K = (b.now = (function () {
                  var a2 = p.performance,
                     b2 =
                        a2 && (a2.now || a2.webkitNow || a2.msNow || a2.mozNow);
                  return b2 && G.bind
                     ? b2.bind(a2)
                     : Date.now ||
                          function () {
   ...
   var require_webflow_lib = __commonJS({
      "packages/shared/render/plugins/BaseSiteModules/webflow-lib.js"(
         ...
         function bindModule(module2) {
            if (Webflow.env()) {
               isFunction(module2.design) &&
                  $win.on("__wf_design", module2.design);
               isFunction(module2.preview) &&
                  $win.on("__wf_preview", module2.preview);
            }
            isFunction(module2.destroy) &&
               $win.on("__wf_destroy", module2.destroy);
         ...
         function unbindModule(module2) {
            isFunction(module2.design) &&
               $win.off("__wf_design", module2.design);
            isFunction(module2.preview) &&
   ...
   var require_engine_v8_version = __commonJS({
      "node_modules/core-js/internals/engine-v8-version.js"(exports, module) {
         ...
         var versions =
            (process2 && process2.versions) || (Deno && Deno.version);
   ...
   document.addEventListener("DOMContentLoaded", function () {
      ...
      const selected = languageSelect.querySelector(".selected");
      const options = languageSelect.querySelector(".options");

      // Відкриття та закриття випадаючого меню
      ...
      options.addEventListener("click", function (e) {
         if (
            ...
            selected.querySelector(".flag").setAttribute("src", flagSrc);
            selected.querySelector(".lang").textContent = lang;

            languageSelect.classList.remove("open"); // Закриваємо меню після вибору мови
         }
      });

      // Закриття випадаючого меню при кліку поза межами
      document.addEventListener("click", function () {
         languageSelect.classList.remove("open");
      });

      // Запобігання закриттю випадаючого меню при кліку всередині його меж
      options.addEventListener("click", function (e) {
         e.stopPropagation();
      });
   });
   // Відкриття вікна при натисканні на кнопку
   ...
   // Закриття вікна при натисканні на поле
      ...
      "node_modules/lodash/_equalArrays.js"(exports, module) {
         ...
         function equalArrays(
            ...
            var index = -1,
               result = true,
               seen =
                  bitmask & COMPARE_UNORDERED_FLAG ? new SetCache() : void 0;
         ...
         ixElements = (state = initialState3, action = {}) => {
            switch (action.type) {
               ...
               case IX2_INSTANCE_ADDED2: {
                  ...
                  let newState = state;
                  if (
                     (0, import_timm3.getIn)(newState, [elementId, ref]) !== ref
                  ) {
   ...
   var require_plugins = __commonJS({
      "packages/systems/ix2/plugins/index.js"(exports) {
         ...
         var pluginMethodMap2 = (exports.pluginMethodMap =
            /* @__PURE__ */ new Map([
               [
               ...
               handler: (
                  ...
                  switch (basedOn) {
                     ...
                     case EventBasedOn.PAGE: {
                        ...
                        value = isXAxis
                           ? Math.min(scrollLeft + pageX, scrollWidth) /
                             scrollWidth
                           : Math.min(scrollTop + pageY, scrollHeight) /
                             scrollHeight;
                        break;
                     }
                     ...
                     default: {
                        ...
                        if (
                           isMouseEvent &&
                           isOrContainsElement({ element, nativeEvent }) !==
                              true
                        ) {
                           break;
                        }
         ...
         Webflow.define(
            ...
            (module.exports = function ($) {
               ...
               function calculateScrollDuration($targetEl, start, end) {
                  ...
                  return (
                     (472.143 * Math.log(Math.abs(start - end) + 125) - 2e3) *
                     mult
                  );
               }
         ...
         Webflow.define(
            ...
            (module.exports = function ($, _) {
               ...
               function submitMailChimp(data) {
                  ...
                  var url =
                     data.action.replace("/post?", "/post-json?") + "&c=?";
   ...
   $(document).ready(function () {
      $(".div-block-112").click(function () {
         $(this).toggleClass("active");
      });

      $(document).ready(function () {
         $(".div-block-145").each(function () {
            var $card = $(this);
            $card.find(".more").on("click", function () {
               $card.find(".expand_legaliza, .etaps_bottom").addClass("active");
               $card.find(".legalize").addClass("active");
            });
            $card.find(".less").on("click", function () {
               $card
                  .find(".expand_legaliza, .etaps_bottom")
                  .removeClass("active");
               $card.find(".legalize").removeClass("active");
            });
         });
      });
   });
...
Webflow.require("ix2").init({
   events: {
      e: {
         ...
         target: {
            id: "66462f92f8138384a13cab9f|d892111e-d0b1-e64d-01b2-2f39585417e4",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-3": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|eab489e6-21a9-f205-da11-8442e6fbd082",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-5": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|82f8b127-2e06-6b64-694a-3ca343daf6f5",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-7": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|d6c71247-86c1-ad47-b4e4-1e26c41dac1a",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-9": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|78e18762-60bf-9639-4153-8227acd4fad3",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-11": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|e0447bc3-e14b-6acc-84af-02cbfc8fcb32",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-13": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|a39157df-588b-db7c-796f-6605cb573f16",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-15": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "66462f92f8138384a13cab9f|34de6140-0e5b-004a-d60e-f163d6dc3ad0",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
   ...
   actionLists: {
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        target: {
                           ...
                           selector: ".div-block-123",
                           selectorGuids: [
                              "f04f630d-6bdb-5607-cb23-53b7430c0eb2",
                           ],
                        },
                        zValue: 180,
                        xUnit: "DEG",
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        duration: 0,
                        target: {
                           selector: ".expand_legaliza.expand_legaliza_left",
                           selectorGuids: [
                              "45b90d70-a6c4-2cae-174b-3f160aaf305b",
                              "64a355fe-b935-e2ca-9aa5-66b7aff37476",
                           ],
                        },
                        value: "block",
                     },
      ...
      "a-4": {
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1719854830418,
      },
      a: {
         id: "a",
         title: "legalize_middle",
         actionItemGroups: [
            {
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        target: {
                           useEventTarget: "CHILDREN",
                           selector: ".div-block-124",
                           selectorGuids: [
                              "8dc08ad0-f81e-fc4a-cc72-3a21bbff4ab4",
                           ],
                        },
                        zValue: 180,
                        xUnit: "DEG",
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        duration: 0,
                        target: {
                           selector: ".expand_legaliza.expand_legaliza_center",
                           selectorGuids: [
                              "45b90d70-a6c4-2cae-174b-3f160aaf305b",
                              "d85b4655-5fbf-bc64-853c-4ac054259dbd",
                           ],
                        },
                        value: "block",
                     },
      ...
      "a-3": {
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1719854324295,
      },
      "a-5": {
         id: "a-5",
         title: "legalize_right",
         actionItemGroups: [
            {
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        target: {
                           useEventTarget: "CHILDREN",
                           selector: ".div-block-125",
                           selectorGuids: [
                              "f9aaabc3-6de5-85c1-9815-2009135a681d",
                           ],
                        },
                        zValue: 180,
                        xUnit: "DEG",
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        duration: 0,
                        target: {
                           selector: ".expand_legaliza.expand_legaliza_right",
                           selectorGuids: [
                              "45b90d70-a6c4-2cae-174b-3f160aaf305b",
                              "b0b052db-4405-6105-9874-93959f5bb08d",
                           ],
                        },
                        value: "block",
                     },
      ...
      "a-6": {
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1719855192794,
      },
      "a-10": {
         id: "a-10",
         title: "hide_left_bottom",
         actionItemGroups: [
            {
               actionItems: [
                  {
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1719856056054,
      },
      "a-9": {
         id: "a-9",
         title: "hide_middle_bottom",
         actionItemGroups: [
            {
               actionItems: [
                  {
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1719855978834,
      },
      "a-8": {
         id: "a-8",
         title: "hide_right_bottom",
         actionItemGroups: [
            {
               actionItems: [
                  {
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        target: {
                           ...
                           selectorGuids: [
                              "3dd3cbbf-959b-efc9-ced1-3df0f3a22722",
                           ],
                        },
                        value: "block",
                     },
      ...
      "a-12": {
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1720713446171,
      },
      "a-13": {
         id: "a-13",
         title: "what_do_you_get_expand",
         actionItemGroups: [
            {
               actionItems: [
                  {
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        duration: 0,
                        target: {
                           selector: ".div-block-116.div-block-116_4",
                           selectorGuids: [
                              "3dd3cbbf-959b-efc9-ced1-3df0f3a22722",
                              "2a5ae5d1-19c5-4736-560c-ca475b973f56",
                           ],
                        },
                        value: "block",
                     },
         ...
         useFirstGroupAsInitialState: false,
         createdOn: 1720958857257,
      },
      "a-14": {
         id: "a-14",
         title: "what_do_you_get_collapse",
         actionItemGroups: [
            {
               actionItems: [
                  {
